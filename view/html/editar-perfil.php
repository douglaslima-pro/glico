        ...
        <main class="l-flex l-full-height" id="main">
            ...
            <section class="overlay-backdrop l-grid l-flex-center is-none">
                <div class="register-glucose" id="alterar-senha">
                    ...
                    <h2 class="register-glucose__title">Alterar senha</h2>
                    <form class="login__form l-margin-2rem-0">
                        ...
                        <label for="senha-nova" class="login__label">
                            ...
                            <div class="login__password-container l-flex l-flex-center" id="input-senha-nova">
                                <input type="password" class="login__input login__input--password" id="senha-nova" name="senha-nova" minlength="4" maxlength="30" required oninput="removeEspacosBrancos('senha-nova')">
                        ...
                        <label for="confirma-senha-nova" class="login__label">
                            ...
                            <div class="login__password-container l-flex l-flex-center" id="input-confirma-senha-nova">
                                <input type="password" class="login__input login__input--password" id="confirma-senha-nova" minlength="4" maxlength="30" required oninput="removeEspacosBrancos('confirma-senha-nova')">
